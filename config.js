...
window.GAME_CONFIG = {
    ...
    game: {
        ...
        winMessage: "Поздравляем с победой!<br>Дарим вам Мини ролл с огурцом при заказе на сумму от 1500 ₽ по промокоду {PROMO_CODE}<br>Воспользоваться промокодом можно на доставку и самовывоз, на сайте и в приложении.",
        promoCode: "GAME",
