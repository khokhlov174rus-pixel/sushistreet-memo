...
window.GAME_CONFIG = {
    ...
    game: {
        ...
        winMessage: "Поздравляем с победой!<br>Дарим вам Тыквенный пирог при заказе на сумму от 3000 ₽ по промокоду {PROMO_CODE}<br>Воспользоваться промокодом можно на доставку и самовывоз, на сайте и в приложении. Промокод действует с 24.02.2026 по 24.03.2026",
        promoCode: "GAME",
